...
const menuItems = [
  { id: 'photography', label: 'Photography', targetId: 'fun-photography' },
  { id: 'illustrations', label: 'Illustrations & Graphics', targetId: 'fun-illustrations' },
  { id: 'ar-vr', label: 'AR/VR Experience', targetId: 'fun-ar-vr' },
  { id: 'animation', label: '2D Animation', targetId: 'fun-animation' },
];

const FunProjectStickyMenu: React.FC = () => {
...
export default FunProjectStickyMenu;
